export const navbar = {
  english: { start: "Start", work: "Work", about: "About", contact: "Contact" },
  german: {
    start: "Start",
    work: "Projekte",
    about: "Infos",
...
export const workSection = {
  ...
  german: { title: "Projekte", teamRef: "Mit: ", siteRef: "Live-Demo" },
};
...
export const contactSection = {
  english: {
    title: "Get in touch",
    form: { name: "Full name", email: "Email", message: "Message" },
    placeholders: {
      name: "Your name",
      email: "Your email",
    ...
    button: "Send",
    loadingAria: "Loading Animation",
    success: "Your message was sent!",
    error:
      "Your message could not be sent. Please contact me via LinkedIn or Github.",
  },
  german: {
    title: "Kontakt",
    form: { name: "Name", email: "E-Mail", message: "Nachricht" },
    placeholders: {
    ...
    button: "Senden",
    loadingAria: "Lade-Animation",
    success: "Deine Nachricht wurde gesendet. Vielen Dank!",
    error:
      "Leider konnte deine Nachricht nicht gesendet werden. Bitte kontaktiere mich alternativ über LinkedIn",
  },
};
